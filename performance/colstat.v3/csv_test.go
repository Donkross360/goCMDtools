...
func TestOperations(t *testing.T) {
	data := [][]float64{
		...
		{5, 5, 8, 2, 2, 9, 75, 8, 45, 3, 2.5, 10.25, 4.75, 6.1, 7.67, 12.287, 5.45},
		{-10, -20},
		{102, 37, 44, 57, 67, 129},
	}

	// Test Cases for Operation Test
	testCases := []struct {
		name string
		op   statsFunc
		exp  []float64
		...
		{"Avg", avg, []float64{37.5, 6.609769230769231, -15, 72.66666666666}},
	}

	// Operatios test execution
...
func TestCSV2Float(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "Column3", col: 3, exp: []float64{236, 220, 226, 218, 218}, expErr: nil, r: bytes.NewBufferString(csvData)},
